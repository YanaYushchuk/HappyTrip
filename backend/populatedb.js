...
async function createTrips() {
  ...
  await Promise.all([
    ...
    tripCreate(3, "Тур Сходом України", "Тур відкриває неповторний шарм  великих міст. У Харкові відвідайте історичну площу Свободи, Харківський планетарій та парк Шевченка. Потім вирушайте до Дніпра, де можна насолодитися красою набережної, відвідати Дніпровський парк та покататися на катамаранах. У Запоріжжі зануртеся у історію на Запорізькій Січі, відвідайте острів Хортицю та насолодіться краєвидами на Дніпро з Токтом.",
