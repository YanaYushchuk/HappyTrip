          ...
          <div key={index} className="ticket-container" id={`ticket-${ticket.id}`}>
            ...
            <div className="ticket-header" style={{ display: "flex", alignItems: "center" }}>
              <div className="ticket-details">
                ...
                <span className="ticket-price">Total price: ${ticket.price}</span>
                <br/>
                <span className="ticket-owner">Owner: {ticket.sender}</span>
              </div>
              <div className="qr-code-container">
                <QRCode value={`Owner: ${ticket.sender}, Total price: ${ticket.price}`} />
              </div>
            </div>
          </div>
        ))}
