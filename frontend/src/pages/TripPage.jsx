...
import './TripPage.css';
import CommentForm from "../CommentForm"; // Шлях до вашого компоненту форми коментарів
        ...
        <div className="mt-4 bg-gray-100 -mx-8 px-8 pt-8">
            ...
            <div className="mt-8 mb-8 grid gap-8 grid-cols-1 md:grid-cols-[2fr_1fr]">
                <div>
                    ...
                    <p>Ціна: {trip.price}</p>
                    <p>Початок туру: {new Date(trip.startTime[0]).toLocaleString()}</p>
                    <p>Кінець туру: {new Date(trip.finishTime[0]).toLocaleString()}</p>
